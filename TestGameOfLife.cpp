...
public:
  virtual std::uint8_t getSizeX() const override {
    return static_cast<std::uint8_t>(m_sizeX);
  }
  virtual std::uint8_t getSizeY() const override {
    return static_cast<std::uint8_t>(m_sizeY);
  }
...
private:
  const std::array<std::array<bool, 1>, 1> m_data = {{{true}}};
  const std::uint8_t m_sizeX = 1;
  const std::uint8_t m_sizeY = 1;
};

void compareStates(const LifeSimulator &simulation, const State &update,
                   const int &updateNum) {
  for (std::uint8_t y = 0; y < update.size(); y++) {
    for (std::uint8_t x = 0; x < update[y].size(); x++) {
      EXPECT_EQ(update[y][x], simulation.getCell(x, y))
          << "Wrong cell state at (" << static_cast<int>(x) << ", "
          << static_cast<int>(y) << ") at update " << updateNum;
    }
  }
}
  ...
  for (std::uint8_t y = 0; y < simulation.getSizeY(); y++) {
    for (std::uint8_t x = 0; x < simulation.getSizeX(); x++) {
      EXPECT_FALSE(simulation.getCell(x, y))
          << "Cell alive at (" << static_cast<int>(x) << ", "
          << static_cast<int>(y) << ")";
    }
  }
}
...
TEST(LifeSimulator_InsertPattern, CanInsertArbitraryPattern) {
  ...
  State insertState = {{false, false, false, false, false, false},
...
TEST(LifeSimulator_InsertPattern, OutOfBoundsHandled) {
  ...
  State successfulInsert = {{false, false, false, false},
...
TEST(LifeSimulator_Update, Underpopulation) {
  LifeSimulator simulation = LifeSimulator(4, 4);
  State cellDeath = {{false, false, false, false},
                     {false, false, false, false},
                     {false, false, false, false},
                     {false, false, false, false}};
...
TEST(LifeSimulator_Update, OutOfBoundsCellsAreDead) {
  ...
  State updated = {{true, true, false, true, true},
...
TEST(LifeSimulator_UpdatePattern, Blinker) {
  ...
  const State update1 = {{false, false, false, false, false, false},
                         {false, false, false, false, false, false},
                         {false, false, false, false, false, false},
                         {false, true, true, true, false, false},
                         {false, false, false, false, false, false},
  ...
  const State update2 = {{false, false, false, false, false, false},
                         {false, false, false, false, false, false},
  ...
  const State update3 = {{false, false, false, false, false, false},
                         {false, false, false, false, false, false},
                         {false, false, false, false, false, false},
                         {false, true, true, true, false, false},
                         {false, false, false, false, false, false},
...
TEST(LifeSimulator_UpdatePattern, Block) {
  ...
  const State update1 = {{false, false, false, false},
                         {false, true, true, false},
                         {false, true, true, false},
                         {false, false, false, false}};

  const State update2 = {{false, false, false, false},
                         {false, true, true, false},
                         {false, true, true, false},
                         {false, false, false, false}};

  const State update3 = {{false, false, false, false},
                         {false, true, true, false},
                         {false, true, true, false},
                         {false, false, false, false}};
...
TEST(LifeSimulator_UpdatePattern, Glider) {
  ...
  State update1 = {{false, false, false, false, false, false},
                   {false, false, true, false, false, false},
  ...
  State update2 = {{false, false, false, false, false, false},
  ...
  State update3 = {{false, false, false, false, false, false},
                   {false, false, false, false, false, false},
